...
if (isset($_GET['error'])) {
    $error = "<div class='error'>Wrong username / password combination.</div>";
    $back = "block";
} else {
    $error = "";
    $back = "none";
                ...
                <form action="logincheck.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-light mt-5">Login</button><a href="index.html" class="btn btn-light mt-5 back">Back!</a>
                        </div>
                </form>
            </div>
        </div>
