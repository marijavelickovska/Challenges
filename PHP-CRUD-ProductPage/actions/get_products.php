...
$sql = "SELECT products.*, dvd.size as size, book.weight as weight, furniture.height as height, furniture.width as width, furniture.length as length FROM products
